...
function PricingCards({ redirect }: { redirect: boolean }) {
  return (
    <div>
      <div className='grid mx-auto max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2'>
        {tiers.map((tier) => (
          <div
            key={tier.id}
          ...
          >
            <div>
              <h3 id={tier.id + tier.name} className='text-base font-semibold text-indigo-600 leading-7'>
                {tier.name}
              </h3>
